...
var PsnService = class {
  ...
  async authenticate(npssoToken) {
    ...
    try {
      ...
      console.log("[AT] Auth response url:", resp.url);
      ...
      console.log("[AT] Auth error message:", e == null ? void 0 : e.message);
      console.log("[AT] Auth error url:", e == null ? void 0 : e.url);
      ...
      const sources = [
        ...
        (_a = e == null ? void 0 : e.headers) == null ? void 0 : _a.location,
        (_b = e == null ? void 0 : e.headers) == null ? void 0 : _b.Location
      ];
